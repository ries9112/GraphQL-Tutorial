...
knitr::include_url('https://thegraph.com/explorer/subgraph/decentraland/marketplace', height = "550px")
```
...
Now we can show the results from the request:
```{r}
decentraland_orders
```
...
```{r}
ggplot(decentraland_data, aes(x=category, y=price_mana)) +
...
We won't dive any deeper into this data here, but see this article for a better understanding of the way different pieces of land are priced based on their location: https://medium.com/nonfungible/short-analysis-of-decentralands-uprising-economy-1e55ac687c35
