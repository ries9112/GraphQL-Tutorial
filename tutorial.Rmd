...
```{r coinpaprika_sandbox-hint, hint=T, warning=F, message=F}
...
The filtering operation above caused the data to go from `r nrowdecentraland1` rows to `r nrowdecentraland2` rows.
...
TODO - Prices over time

TODO - Prices over time - facet by category
...
TODO - Prices USD over time

TODO - Prices USD over time - facet by category


We won't dive any deeper into this data here, but see this article for a better understanding of the way different pieces of land (parcels) are priced based on their location: https://medium.com/nonfungible/short-analysis-of-decentralands-uprising-economy-1e55ac687c35
